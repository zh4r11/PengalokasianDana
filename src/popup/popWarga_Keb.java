...
public class popWarga_Keb extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    
    public kebersihan keb = null;
    ...
    Object[] Baris ={"Nomor KK","Nama Kepala Keluarga","No. Telp","Alamat"};
    ...
    private void tbwargaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbwargaMouseClicked
        ...
        keb.kk = tbwarga.getValueAt(tblwarga, 0).toString(); 
        keb.nama = tbwarga.getValueAt(tblwarga, 1).toString();
        keb.alamat = tbwarga.getValueAt(tblwarga, 3).toString();
        keb.setBayar();
        keb.itemTerpilihWarga();       
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popWarga_Keb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popWarga_Keb().setVisible(true);
            }
        });
    }
