...
public class popWarga_Kea extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    
    public keamanan kea = null;
    ...
    private void tbwargaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbwargaMouseClicked
        ...
        kea.kk = tbwarga.getValueAt(tblwarga, 0).toString(); 
        kea.nama = tbwarga.getValueAt(tblwarga, 1).toString();
        kea.alamat = tbwarga.getValueAt(tblwarga, 3).toString();
        kea.setBayar();
        kea.itemTerpilihWarga();       
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popWarga_Kea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popWarga_Kea().setVisible(true);
            }
        });
    }
